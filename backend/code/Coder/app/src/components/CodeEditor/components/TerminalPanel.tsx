...
interface TerminalPanelProps {
  ...
  problems: Array<{ file: string; line: number; severity: 'error' | 'warning' | 'info'; message: string }>
  output: string[]
  debugOutput: string[]
        ...
        <div className="terminal-content">
          {terminalPanelTab === 'problems' && (
            <div className="terminal-view">
              {problems.length === 0 ? (
                <div className="terminal-empty">No problems detected</div>
              ) : (
                <div className="problems-list">
                  {problems.map((problem, idx) => (
                    <div key={idx} className={`problem-item problem-${problem.severity}`}>
                      ...
                      <span className="problem-line">({problem.line})</span>
